class TabLink {
  constructor(tabElement){
    ...
    if(this.tabData === 'all'){
      ...
      console.log('we made it so far' + this.cards)
    } else {
      // else if `all` is false, only select the cards with matching this.tabData values
      // this.cards = ;
      this.cards = document.querySelectorAll(`.card[data-tab='${this.tabData}']`)
      console.log('but did me make it here?' + this.cards)
  ...
  selectTab(){
    ...
    console.log(this.cards + "OMG PLZ WORK")
...
*/
tabs = document.querySelectorAll('.tab').forEach(function(tab){
